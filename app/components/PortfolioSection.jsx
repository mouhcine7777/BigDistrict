              ...
              <div className="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-2">
                ...
                >
                  ...
                  <div className="relative h-full p-6 md:p-8 lg:p-12 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-5 py-2 bg-white text-[#ED2410] font-semibold text-xl uppercase group-hover:scale-105 transition-transform duration-300">
                      Discover More
