      ...
      <div className="relative py-16 md:py-20 bg-gradient-to-r from-white via-gray-200 to-white overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center justify-center">
          <div className="flex flex-col items-center w-full">
            ...
            >
              <div className="relative z-10 inline-flex items-center gap-4 px-5 py-2 bg-[#ED2410] text-white text-base md:text-xl uppercase overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-[#ED2410]/30">
